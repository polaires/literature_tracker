...
export const TopHeader = memo(function TopHeader({
  ...
  return (
    <header className="h-14 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center px-4 gap-4 flex-shrink-0 relative z-10">
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <button
          onClick={() => navigate('/')}
          className="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors sm:hidden"
        ...
        <button
          ...
          className="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors lg:hidden"
        ...
        <div className="min-w-0 hidden sm:block">
          <h1 className="text-sm font-medium text-gray-600 dark:text-gray-300 truncate max-w-[200px] lg:max-w-[300px]">
            {thesis.title}
          </h1>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
