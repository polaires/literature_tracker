...
export const ARGUMENT_STRENGTH_COLORS = {
  strong: {
    ...
    text: 'text-green-700 dark:text-green-300',
    label: 'Strong',
    icon: 'CircleDot', // Filled circle - strong presence
  },
  moderate: {
    bg: 'bg-yellow-100 dark:bg-yellow-900/30',
    text: 'text-yellow-700 dark:text-yellow-300',
    label: 'Moderate',
    icon: 'Circle', // Half-filled appearance
  },
  weak: {
    bg: 'bg-red-100 dark:bg-red-900/30',
    text: 'text-red-700 dark:text-red-300',
    label: 'Weak',
    icon: 'CircleDashed', // Dashed circle - weak presence
  },
};

// Argument Assessment Colors (user's view on the argument)
